...
public class BloodBankSearchFragment extends Fragment implements OnClickListener{
	View rootView;
	EditText mName;
	Button mSearch;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		rootView=inflater.inflate(R.layout.fragment_search_bloodbank, container,false);
	...
	private void Search() {
		...
		AsyncFragmentHandler ahandler=new AsyncFragmentHandler(getActivity(), nameValuePair, AppConstants.URL_SEARCHBLOODBANK, AppConstants.MESSAGE_LOADING,AppConstants.PAGE_SEARCHBLOODBANK,new FragmentCallback() {
