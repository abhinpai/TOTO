...
public class EditHospital extends AppCompatActivity implements OnClickListener{
	...
	private void AsynkEditHospitalData() {
		...
		AsyncTaskHandler ahandler=new AsyncTaskHandler(EditHospital.this, nameValuePair, AppConstants.URL_EDITHOSPITAL, AppConstants.MESSAGE_LOADING,AppConstants.PAGE_EDITHOSPITAL);
		ahandler.execute();
	}
