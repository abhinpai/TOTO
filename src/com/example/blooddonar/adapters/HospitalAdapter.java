...
public class HospitalAdapter extends BaseAdapter {
	...
	public HospitalAdapter(Activity activity,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null)
		{
			v=inflater.inflate(R.layout.list_item_hospital, parent, false);
			...
			holder.edit.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					Intent intent=new Intent(activity,EditHospital.class);
			...
			holder.delete.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					AsyncTaskHandler ahandler=new AsyncTaskHandler(activity, nameValuePair, AppConstants.URL_DELETEHOSPITAL, AppConstants.MESSAGE_LOADING,AppConstants.PAGE_DELETEHOSPITAL);
					ahandler.execute();
				}
			});
			v.setTag(holder);
