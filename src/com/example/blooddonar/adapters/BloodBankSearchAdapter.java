...
public class BloodBankSearchAdapter extends BaseAdapter {
	...
	public BloodBankSearchAdapter(Activity activity,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null)
		{
			v=inflater.inflate(R.layout.list_item_search_bloodbank, parent, false);
